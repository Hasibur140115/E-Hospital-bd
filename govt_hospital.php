...
<div class="container-fluid" style="margin-top: 40px;">
    ...
    <div class="col"> 
      <center>
        <h2 style="font-family:'Alfa Slab One';">Govt. Hospital Informantion</h2>
      </center>
       </div>
</div><br><br>
<!-- Alignment -->
...
<div class="container">
  ...
  <div class="row" >
    <div class="col">
      <button type="button" class="btn btn-outline-dark btn-block" data-toggle="modal" data-target="#myModal">
    জাতীয় কিডনী ইনষ্টিটিউট এবং হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#myModal1">
    শহীদ সোহরাওয়াদী মেডিকেল কলেজ হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-success btn-block" data-toggle="modal" data-target="#myModal2">
    জাতীয় ক্যান্সার গবেষণা ইনস্টিটিউট ও হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-secondary btn-block" data-toggle="modal" data-target="#myModal3">
  ...
  <div class="row" >
    <div class="col">
      <button type="button" class="btn btn-outline-dark btn-block" data-toggle="modal" data-target="#myModal4">
    বঙ্গবন্ধু শেখ মুজিব মেডিকেল বিশ্ববিদ্যালয় হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#myModal5">
    ঢাকা শিশু হাসপাতাল
  </button>
    </div>
    <div class="col">
    ...
    <div class="col">
      <button type="button" class="btn btn-outline-secondary btn-block" data-toggle="modal" data-target="#myModal7">
    জাতীয় অর্থোপেডিক হাসপাতাল (পঙ্গু হাসপাতাল)
  </button>
    </div>
  </div><br>
  ...
  <div class="row" >
    <div class="col">
      <button type="button" class="btn btn-outline-dark btn-block" data-toggle="modal" data-target="#myModal8">
    জাতীয় হৃদরোগ ইনস্টিটিউট ও হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#myModal8">
    জাতীয় চক্ষু বিজ্ঞান ইনস্টিটিউট ও হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-success btn-block" data-toggle="modal" data-target="#myModal10">
    জাতীয় মানসিক স্বাস্থ্য ইনস্টিটিউট ও হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-secondary btn-block" data-toggle="modal" data-target="#myModal11">
  ...
  <div class="row" >
    <div class="col">
      <button type="button" class="btn btn-outline-dark btn-block" data-toggle="modal" data-target="#myModal12">
    ঢাকা মহানগর জেনারেল হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#myModal13">
    সরকারী ইউনানী ও আয়ুর্বেদিক মেডিকেল কলেজ ও হাসপাতাল
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-success btn-block" data-toggle="modal" data-target="#myModal14">
    আইসিডিডিআরবি
  </button>
    </div>
    <div class="col">
      <button type="button" class="btn btn-outline-secondary btn-block" data-toggle="modal" data-target="#myModal15">
