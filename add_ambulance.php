		...
		<div class="col-md-9" style="padding-bottom: 50px;">
			...
			<div class="card">
				<div class="card-body" style="background-color: #3498DB;color: #ffffff;">
					<center> ADD A AMBULANCE DETAILS
				</div></center>
				...
				<div class="card-body">
					...
					<form class="form-group" action="func.php" method="post">
						...
						<input type="text" name="division" class="form-control" required><br>
						<label>District Name:</label>
						<input type="text" name="district" class="form-control" required><br>
						<label>Hospital Name:</label>
						<input type="text" name="amhospital" class="form-control" required><br>
						<label>Branch Name:</label>
						<input type="text" name="ambranch" class="form-control" required><br>
						<label>Contact :</label>
						<input type="text" name="amcontact" class="form-control" required><br>
						<center>
							<input type="submit" class="btn btn-primary" name="amb_submit" value="submit">
						</center>
