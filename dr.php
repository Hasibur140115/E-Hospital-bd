    ...
    <ul class="navbar-nav mr-auto" style=" padding-right: 5px;">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #232827;">
          <a class="dropdown-item" href=""style="color: #fff;background-color: #232827;">Goal & Objective</a>
...
<div class="container-fluid" style=" margin-top: 25px;">
    ...
    <div class="col" > 
      <center><h2 style="font-family:'Alfa Slab One';">Our Doctors Center</h2></center> 
    </div>
</div>

<!-- search ber -->
<div class="container" style="padding: 10px; margin-top: 30px; margin-bottom: 50px;">
  <div class="row justify-content-md-center">
    <div class="col-sm-11">
      <div class="row">
      	<div class="col-sm-4">  
      		<form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" placeholder="Service By Dr. Name" aria-label="Search">
            </form>
        </div>
      	<div class="col-sm-4">
      	        <form class="form-inline my-2 my-lg-0">
                     <input class="form-control mr-sm-2" type="search" placeholder="Service By Speciality" aria-label="Search">
                </form>
        </div>
      	<div class="col-sm-4">
      	    <form class="form-inline my-2 my-lg-0">
                 <input class="form-control mr-sm-2" type="search" placeholder="Service By Branch" aria-label="Search">
            </form> 
        </div>
      </div>
    </div>
    <div class="col-sm-1"><button type="button" class="btn btn-outline-dark">Scarch</button></div>
  </div>
</div>
...
<nav aria-label="Page navigation example" style="margin-bottom: 50px; margin-top: 50px;">
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
      <a class="page-link" href="#" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    <li class="page-item"><a class="page-link" href="dr1.php">1</a></li>
    <li class="page-item"><a class="page-link" href="dr2.php">2</a></li>
    <li class="page-item"><a class="page-link" href="dr3.php">3</a></li>
    <li class="page-item"><a class="page-link" href="dr4.php">4</a></li>
    <li class="page-item"><a class="page-link" href="dr5.php">5</a></li>
    <li class="page-item">
