          ...
          <div class="col-md-9">
               ...
               <div class="card">
                 <div class="card-body" style="background-color: #3498DB;color: #ffffff;">
                   <div class="row">
                      <div class="col-md-4"><h3>Ambulance Details</h3></div>
                        <div class="col-md-8">
                          
                            <div>
                                <input class="form-control" id="myInput" type="text" placeholder="Search By Division , District , Hospital_Name , Branch_Name , content ">
                              </div>
