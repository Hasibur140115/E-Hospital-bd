...
<div class="container-fluid" >
          ...
          <div class="col-md-9">
               ...
               <div class="card">
                 <div class="card-body" style="background-color: #3498DB;color: #ffffff;">
                   <div class="row">
                      <div class="col-md-4"><h3>Doctors Details</h3></div>
                        <div class="col-md-8">
                          
                            <div>
                                <input class="form-control" id="myInput" type="text" placeholder="Search By Dr_Neme, Dr_Degree, Specitilies, Visiting_Day, Visiting_Hour, Contact">
                              </div>
  ...
  <br>
  <table class="table text-center" style="border:2px solid #DEE2E6; color: #fff;" >
    <thead>
      <tr>
        <th>Dr.Name</th>
        <th>Dr.Degree</th>
