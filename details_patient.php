          ...
          <div class="col-md-9">
               ...
               <div class="card">
                 <div class="card-body" style="background-color: #3498DB;color: #ffffff;">
                   <div class="row">
                      <div class="col-md-4"><h3>Patient Details</h3></div>
                        <div class="col-md-8">
                          
                            <div>
                                <input class="form-control" id="myInput" type="text" placeholder="Search By Name, Address, Dr_Name, Visiting_Day, Visiting_Hour, Contact">
                              </div>
