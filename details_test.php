...
<html lang="en">
<head>
  <title>Test & Charge Details</title>
  <meta charset="utf-8">
...
<div class="container-fluid" >
          ...
          <div class="col-md-9">
               ...
               <div class="card">
                 <div class="card-body" style="background-color: #3498DB;color: #ffffff;">
                   <div class="row">
                      <div class="col-md-4"><h3>Test & Charge Details</h3></div>
                        <div class="col-md-8">
                          
                            <div>
                                <input class="form-control" id="myInput" type="text" placeholder="Search By Test_Neme, Branch_Name, Price_Values">
                              </div>
  ...
  <br>
  <table class="table text-center"style="border:1px solid #DEE2E6; color: white;">
    <thead>
      <tr>
        <th>Test_Name</th>
        <th>Test_Center</th>
