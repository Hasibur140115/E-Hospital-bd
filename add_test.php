		...
		<div class="col-md-9">
			...
			<div class="card">
				<div class="card-body" style="background-color: #3498DB;color: #ffffff;">
					<center>TEST AND SERVICE CHARGES</center> 
				</div>
				...
				<div class="card-body">
					...
					<form class="form-group" action="func.php" method="post">
						...
						<input type="text" name="testname" class="form-control" required=""><br>
						<label> Test Center:</label>
						<input type="text" name="testcenter" class="form-control" required=""><br>
						<label>Test Price:</label>
						<input type="text" name="testprice" class="form-control" required=""><br>
						<center><input type="submit" class="btn btn-primary" name="test_submit" value="submit"></center>
