			...
			<div class="card">
				...
				<div class="card-body">
					...
					<form class="form-group" action="func.php" method="post">
						...
						<input type="text" name="serial" class="form-control" required><br>
						...
						<center>
							<input type="submit" class="btn btn-primary" name="news_update" value="update">
						</center>
