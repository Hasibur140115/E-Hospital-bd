...
<!-- Find Doctor -->
<div class="container-fluid" style="background-color: #fff; margin-top: 1px;">
  
  <div class="row" style="padding-top: 15px;">
    <div class="col-9" style="padding-left: 40px; padding-top: 5px; color: #900C3F;">
    	<center><h3>Abour Us</h3></center>
    </div>
    <div class="col-3">
      <nav aria-label="breadcrumb" >
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
    <li class="breadcrumb-item"><a href="about.php">About Us Center</a></li>
